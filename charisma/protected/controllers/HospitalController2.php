...
class HospitalController extends CController
{
        public $breadcrumbs;
	/**
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Hospital']))
		{
                       ...
                       if (!empty($model->hopitalName)) $criteria->addCondition('hopitalName = "'.$model->hopitalName.'"');
                 ...
                 $session['Hospital_records']=Hospital::model()->findAll($criteria); 
