...
class HospitalController extends GxController {
...
public function actionUpdateBooster()
	{
		    $es = new EditableSaver('Hospital');
			$es->update();
	}
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Hospital'),
		));
	}
	...
	public function actionCreate() {
		...
		if (isset($_POST['Hospital'])) {
			$model->setAttributes($_POST['Hospital']);
	...
	public function actionDelete($id) {
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'Hospital')->delete();
	...
	public function actionAdmin() {
		...
		if (isset($_GET['Hospital']))
			$model->setAttributes($_GET['Hospital']);
  ...
  public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Hospital_records']))
               {
                $model=$session['Hospital_records'];
               }
               else
    ...
    public function actionGeneratePdf() 
	{
		...
		$pdf->SetSubject('Hospital Report');
