...
class InvoiceController extends CController
{
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Invoice']))
		{
                       ...
                       if (!empty($model->idmember)) $criteria->addCondition('idmember = "'.$model->idmember.'"');
                     
                    	
                       if (!empty($model->idhospital)) $criteria->addCondition('idhospital = "'.$model->idhospital.'"');
                 ...
                 $session['Invoice_records']=Invoice::model()->findAll($criteria); 
