...
$this->widget('bootstrap.widgets.TbMenu', array(
    ...
    array('label'=>'Formulaire des sois du patient', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('members/formulaire',array('id'=>$_GET['id'])), 'linkOptions'=>array()),
    array('label'=>'Ordonnance Medicale', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('members/ordonnanceMedicale',array('id'=>$_GET['id'])), 'linkOptions'=>array()),
    array('label'=>'Medical spectacle prescription', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('members/lunette',array('id'=>$_GET['id'])), 'linkOptions'=>array()),
    array('label'=>'Bullettin d\'analyse', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('members/analyseDemande',array('id'=>$_GET['id'])),'active'=>true, 'linkOptions'=>array()),
