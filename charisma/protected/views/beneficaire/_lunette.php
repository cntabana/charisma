...
$this->widget('bootstrap.widgets.TbMenu', array(
  ...
  array('label'=>'Ordonnance Medicale', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('beneficaire/ordonnanceMedicale',array('id'=>$_GET['id'])), 'visible'=>Yii::app()->user->groupe!=2,'linkOptions'=>array()),
    array('label'=>'Medical spectacle prescription', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('beneficaire/lunette',array('id'=>$_GET['id'])),'visible'=>Yii::app()->user->groupe!=2,'active'=>true, 'linkOptions'=>array()),
...
<table width='80%' border=0>
 ...
 <tr><td colspan=4>&nbsp;</td></tr>
    ...
    <td COLSPAN=4> Identite du patient / Patient identity :<br>
       <ul>
              <li>Noms de I'adherent/ Names of affiliate :<?php echo $row['firstname'].' '.$row['middlename'].' '.$row['lastname'];?></li>
              <li>N° de la carte de Paffilie / Affiliate card N° <?php echo $row['cardnumber']; ?></li>
              <li>Departernent affectataire / Employer</li>
              <li>Beneficiaire / Beneficiary:
                   <ul>
                      <li>Adherent lui-meme / Self: Yes</li>
                      <li>Conjoint / Partner: D Noms / Names <?php if($data->type == 1) echo CHtml::encode($data->firstname).' '.CHtml::encode($data->middlename).' '.CHtml::encode($data->lastname); ?></li>
                      <li>Enfant / Infant: D Noms / Names <?php if($data->type == 2)echo CHtml::encode($data->firstname); ?> <?php echo CHtml::encode($data->middlename); ?> <?php echo CHtml::encode($data->lastname); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Age</li>
                   </ul>
              </li>
       </ul>
    </td>
