...
$this->widget('bootstrap.widgets.TbMenu', array(
    ...
    array('label'=>'Ordonnance Medicale', 'icon'=>'icon-th-list', 'url'=>Yii::app()->controller->createUrl('beneficaire/ordonnanceMedicale',array('id'=>$_GET['id'])),'visible'=>Yii::app()->user->groupe!=2,'active'=>true, 'linkOptions'=>array()),
	...
	<tr> 
		 <td>
            <ul>
              ...
              <li>Numero de la carte : <?php echo $row['cardnumber']; ?>
